...
\formatauthor{Bracha Nir}{\begin{tabular}{@{}c@{}}University of Haifa\end{tabular}}
...
\noindent
% APA Style
Melnik, Nurit, \& Nir, Bracha. 2019. . In Müller, Stefan, \& Osenova, Petya (Eds.), \emph{{Proceedings of the 26th International Conference on Head-Driven Phrase Structure Grammar, University of Bucharest}}, 6--6. Stanford,
CA: CSLI Publications. \hfill\href{http://creativecommons.org/licenses/by/4.0/}{\includegraphics[height=.75em]{Includes/ccby.eps}}

\newpage
\includepdf[pages=-,pagecommand=\thispagestyle{plain}]{Includes/melnik-nir.pdf}
        \end{document}
