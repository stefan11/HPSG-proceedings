...
General procudure and timelines as of 2024:
\begin{itemize}
\item January/February: Call for papers
\item March: submission of papers via easychair
\item April: reviewing results
\item June/July/August: conference
\item October 15th: submission of full paper formatted according to the following guidelines
      \begin{itemize}
      \item normal papers: 20 pages + references
      \item invited talks may submit up to 25 pages + references
      \end{itemize}
\item November 15th: Review of full papers by two reviewers via easychair
\item Revised papers can address reviewer comments on one additional page.
\item December 15th: Submission of the finalized papers via Email to Stefan Müller. See checklist at
  the end of this document for the format and the format of the abstract that is required together
  with the submission.
\end{itemize}
...
The page limit for full papers is 20 pages and 25 pages for invited talks. The title page and the
list of references do not count with respect to the page limit. There will be one extra page to
address comments by the reviewers of the full papers.
...
\item Are you within the page limit of 20/21 pages or 25/26 pages for invited papers?
...
\section{Initial submission for review}

As of 2024, there is an additional review step. Please submit your paper for review at: easychair.%\url{https://proceedings.hpsg.xyz/}.

\section{Submission of final paper}

The final submission is per email.
