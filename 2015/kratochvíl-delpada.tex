...
\noindent
% APA Style
Kratochvíl, František, \& Delpada, Benidiktus. (2015). Degrees of affectedness and verbal prefixation in Abui (Papuan). In Stefan Müller (Ed.): \emph{Proceedings of the 22nd International Conference on Head-Driven Phrase Structure Grammar, Nanyang Technological University (NTU), Singapore} (pp.\ 87--87). Stanford, CA: CSLI Publications.

\newpage
\includepdf[pages=-,pagecommand=\thispagestyle{plain}]{Includes/kratochvíl-delpada.pdf}
        \end{document}
